...
class EnclaveState(angr.SimStatePlugin):
    def __init__(self,
                 proj=None,
                 control_state=controlstate.ControlState.SgxEntry,
                 ooe_rights=controlstate.Rights.ReadWrite,
                 violation=None,
                 found_violation=False,
                 jump_trace=None,
                 call_stack=None,
                 entry_sanitisation_complete=False,
                 temporary_stack=True,
                 entry_state=None):
        super().__init__()
        ...
        self.temporary_stack = temporary_stack
    ...
    def copy(self, memo):
        return EnclaveState(
            ...
            temporary_stack=self.temporary_stack,
